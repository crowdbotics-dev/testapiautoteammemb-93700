...
## Project Structure
    ...
    ├── testapiautoteammemb_93700  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_93700`
...
2. Clone this repo and `cd testapiautoteammemb_93700`
